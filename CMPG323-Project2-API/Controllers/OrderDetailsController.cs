...
using CMPG323_Project2_API.Models;
...
namespace CMPG323_Project2_API.Controllers
{
    ...
    {
        private readonly dbCMPG323Project2Context _context;

        public OrderDetailsController(dbCMPG323Project2Context context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<OrderDetail>> PostOrderDetail(OrderDetail orderDetail)
        {
          if (_context.OrderDetails == null)
          {
              return Problem("Entity set 'dbCMPG323Project2Context.OrderDetails'  is null.");
          }
